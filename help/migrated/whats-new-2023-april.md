...
Microsoft Teams上的全新Adobe Learning Manager應用程式旨在促進工作流程中的學習，並提升社交學習效果。 學習者無需切換至瀏覽器，即可存取Microsoft Teams平台內的學習內容。 請聯絡您的CSAM，以取得MS Teams上AdobeLearning Manager應用程式的測試版。

如需詳細資訊，請參閱 [Microsoft Teams專用AdobeLearning Manager應用程式](/help/migrated/adobe-learning-manager-app-microsoft-teams.md).
...
## 新增AdobeLearning Manager Mobile應用程式

適用於Android和iOS的全新AdobeLearning Manager行動應用程式，讓學習者能順暢地存取行動中的學習內容。 此應用程式可讓學習者使用行動裝置上的訓練，並於稍後在案頭上繼續進行。 行動應用程式支援通知、檔案上傳、輕鬆建立書籤和分享學習內容、社交學習等，為學習者提供額外彈性，並支援即時學習。

![新的行動地圖介面影像](assets/mobile-app.png)
...
* 支援增強型LP
* 將行動介面語言變更為任何AdobeLearning Manager支援的語言的功能。
...
如需詳細資訊，請參閱 [AdobeLearning Manager行動應用程式](/help/migrated/learners/feature-summary/ipad-android-tablet-users.md).
...
![建立註解](assets/create-announcement.png)
...
![建議分段學習者](assets/recommendation-strip-learner.png)
...
![行事曆上的工作階段未套用篩選器](assets/sessions-on-calendar-no-filters.png)

![套用到位置的篩選器](assets/location-filter-applied.png)

![行事曆上已套用位置篩選的工作階段](assets/session-with-location-filters-applied.png)
...
如需詳細資訊，請參閱 [管理員設定](/help/migrated/administrators/feature-summary/settings.md).
...
當學習者選取 **檢視所有執行個體**，學習者即可檢視所有課程例項。

![檢視所有執行個體](assets/view-all-instances-new.png)

管理員可以切換學習者的例項。

![切換例項](assets/switch-instances.png)
...
如需詳細資訊，請參閱 [執行個體設定](/help/migrated/authors/feature-summary/courses.md).
...
如需詳細資訊，請參閱 [使用者稽核軌跡報表](/help/migrated/administrators/feature-summary/reports.md#useraudittrailreports).

### 講師使用報告

此報表可擷取講師在授課指派工作階段時每天所花的時間（以分鐘為單位）。 報表可從選取的開始日期下載三個月。

如需詳細資訊，請參閱 [講師使用率報表](/help/migrated/administrators/feature-summary/reports.md#instructor-utilization-report).
...
* **generateJobAidMetadataReport**：傳回工作輔助報表的中繼資料。
