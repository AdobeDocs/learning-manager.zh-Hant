...
1. 選取 **[!UICONTROL Content Library]** 在下列身分登入後位於左窗格： **作者** 並選取 **[!UICONTROL Add]**.
...
1. Learning Manager支援在Learning Manager中上傳影片內容的字幕。 現在，作者可以上傳包含註解的檔案以及視訊檔案。
   ...
   將視訊內容新增至資料庫時，您也可以新增VTT檔案， **必須** 為有效檔案。
...
1. 在 **[!UICONTROL Duration]** 欄位，您可以選擇輸入學習者要在此單元中花費的預期時間。 持續時間以分鐘為單位。
1. 在 **[!UICONTROL Tags]** 欄位中，輸入已上傳內容的標籤，以便您的內容變成可探索。
...
1. 若要新增不同語言的測驗，請選取 **新增語言** 標籤，然後選擇所需的語言。 使用此方法，您可以為內容新增多語言支援。
...
測驗將新增至 **[!UICONTROL Content Library]**. 和「內容庫」中的任何內容一樣，您可以淘汰測驗，然後刪除測驗。
...
1. 若要新增不同語言的內容，請按一下 **新增語言** 標籤，然後選擇所需的語言。 使用此方法，您可以為內容新增多語言支援。
...
>[!NOTE]
>
>您也可以從以下位置新增內容： **[!UICONTROL Retired]** 區段，導覽至 **[!UICONTROL Content Library]** > **[!UICONTROL Retired]** 並選取 **[!UICONTROL Add Content]**. 如需詳細資訊，請參閱 [新增靜態內容](content-library.md#addstaticcontent).
