...
jcr-language: en_us
title: 學習管理器中的 xAPI
description: 體驗 API（xAPI）是一項電子學習軟體規範，允許學習內容與學習系統以方式相互溝通，並記錄並追蹤各類學習經驗。
...
欲了解更多 xAPI 資訊，請參見：  [https://github.com/adlnet/xAPI-Spec](https://github.com/adlnet/xAPI-Spec)。

## Learning Manager 如何支援 xAPI？ {#howdoescaptivateprimesupportxapi}
...
1. 以整合管理員身份登入。 選擇 **[!UICONTROL Applications]** > **[!UICONTROL Register]**。
...
注意：Learning Manager 支援的 xAPI 版本為 1.0.3。
...
xAPI 報告可以產生為 Excel 報告。 作為管理員，請>> **[!UICONTROL Reports]** **[!UICONTROL Excel reports]** **[!UICONTROL xAPI activity report]**。

下載的報告會取得學習者與管理員發布的所有陳述資訊。

同樣的報表也可以用 FTP 和 Box 連接器來執行/排程，用於任何第三方整合。 請遵循以下步驟：

以整合管理員身份登入>開啟 FTP/Box 連接器>從左側窗格選擇 xAPI 活動報告>選擇排程/產生報告。
