 ...
 <tbody>
  <tr>
   <td style="border:none;">
    ...
    <img alt="開始使用 Content Composer" src="../assets/cc-get started.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="what-is-content-composer.md"><strong>開始使用 Content Composer</strong></a>
    </div>
    <p>內容撰寫者是什麼、是為誰設計的，以及在開始前你需要什麼。</p>
   </td>
   <td style="border:none;">
    <a href="write-a-prompt.md">
    <img alt="建立課程" src="../assets/cc-create-course.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="write-a-prompt.md"><strong>建立課程</strong></a>
    </div>
    <p>從簡單的語言提示，在單一引導的工作流程中，逐步轉換成可發表的課程。</p>
   </td>
   <td style="border:none;">
    <a href="general-course-settings.md">
    <img alt="設定課程設定" src="../assets/cc-course-settings.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="general-course-settings.md"><strong>設定課程設定</strong></a>
    </div>
    <p>在發佈前，先設定完成標準、測驗分數，以及你的 Adobe Learning Manager 連結。</p>
   </td>
  </tr>
  <tr>
   <td style="border:none;">
    <a href="apply-theme.md">
    <img alt="管理課程主題" src="../assets/cc-branding.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="apply-theme.md"><strong>管理課程主題</strong></a>
    </div>
    <p>應用、客製化、創建並匯入視覺主題，以掌控你的球場外觀與氛圍。</p>
   </td>
   <td style="border:none;">
    <a href="share-collaborate.md">
    <img alt="分享與協作" src="../assets/cc-share.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="share-collaborate.md"><strong>分享與協作</strong></a>
    </div>
    <p>分享您的課程供同事複習，或讓學習者直接取得課程。</p>
   </td>
   <td style="border:none;">
    <a href="publish-to-alm.md">
    <img alt="發佈到 Adobe Learning Manager" src="../assets/cc-publish-alm.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="publish-to-alm.md"><strong>發佈到 Adobe Learning Manager</strong></a>
    </div>
    <p>將完成的課程部署到 Adobe Learning Manager，了解內容撰寫者與 ALM 如何分工撰寫、交付與報告責任。</p>
   </td>
  </tr>
  <tr>
   <td style="border:none;">
    <a href="write-effective-prompts.md">
    <img alt="撰寫有效的提示" src="../assets/cc-prompts.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="write-effective-prompts.md"><strong>撰寫有效的提示</strong></a>
    </div>
    <p>學習如何撰寫提示詞，產生更優質的簡報、更強健的大綱，以及更準確的 AI 生成內容。</p>
   </td>
 ...
 <tbody>
  <tr>
   <td style="border:1px solid transparent;">
    ...
    <img alt="Beta 限制" src="../assets/cc-limitations.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="content-composer-beta-limitations.md"><strong>Beta 限制</strong></a>
    </div>
    <p>完整的目前限制、變通方法及路線圖狀態清單。 隨著功能發佈而更新。</p>
   </td>
   <td style="border:1px solid transparent;">
    <a href="content-composer-faq.md">
    <img alt="內容撰寫者常見問題" src="../assets/cc-faq.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="content-composer-faq.md"><strong>內容撰寫者常見問題</strong></a>
    </div>
    <p>關於撰寫、設定、分享與出版的最常見問題，快速解答。</p>
   </td>
   <td style="border:1px solid transparent;">
    <a href="theme-json-reference.md">
    <img alt="主題 JSON 屬性參考" src="../assets/cc-theme-ref.png" style="width:200px; height:120px; object-fit:cover;">
    </a>
    <div>
    <a href="theme-json-reference.md"><strong>主題 JSON 屬性參考</strong></a>
    </div>
    <p>Content Composer 主題中的每個屬性 JSON 架構，並附有描述與範例值。</p>
   </td>
  </tr>
 </tbody>
</table>
