...
更新標題和正文字體，使其更符合你的內容或品牌。

1. 從工具列選擇 **主題** ，然後將滑鼠移到套用主題上，選擇 **編輯**。 **編輯主題**&#x200B;面板會打開，顯示主題的色彩調色盤和字體。
...
3. 選擇 **正文** 下拉選單，並選擇課程正文的字型。 例如，選擇 **DM Sans**。
...
>[!NOTE]
>
>預設主題無法直接編輯。 要自訂預設主題，請編輯它，然後選擇「另存為新」，以建立基於原始主題的自訂主題。
