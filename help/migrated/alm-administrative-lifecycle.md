...
如需詳細資訊，請參閱Adobe Learning Manager中的[自訂角色](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/custom-role)
...
* [身分型別](https://helpx.adobe.com/enterprise/using/admin-console.html)
* [安全的使用者驗證和密碼](https://helpx.adobe.com/enterprise/using/authentication-settings.html)

## 角色指派與存取控制

現有系統管理員透過明確的[角色指派](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/user-management/add-users-user-groups)來控制對Adobe Learning Manager中管理帳戶的存取。 安全管理存取的主要特性包括：
...
如需詳細資訊，請參閱[安全使用者驗證](https://helpx.adobe.com/enterprise/using/authentication-settings.html)。


## 以管理員身分登入

ALM [管理員](https://experienceleague.adobe.com/en/docs/learning-manager/using/get-started/getting-started-admin)使用透過Admin Console管理的組織認證，直接登入ALM平台。
...
如需詳細資訊，請參閱[新增使用者和使用者群組](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/user-management/add-users-user-groups)。
...
如需詳細資訊，請參閱[設定](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/settings)。
...
請參閱[Adobe Learning Manager管理員的常見問題](https://experienceleague.adobe.com/en/docs/learning-manager/using/faq/frequently-asked-questions-for-administrators)
...
如需詳細資訊，請參閱[Admin Console總覽](https://helpx.adobe.com/enterprise/using/admin-console.html)。
...
* [新增使用者和使用者群組](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/user-management/add-users-user-groups)
...
* [在Admin Console上建立、更新或移除使用者帳戶](https://helpx.adobe.com/enterprise/using/manage-users-individually.html)
* [如何離開貴組織擁有的帳戶](https://helpx.adobe.com/enterprise/using/leave-organization.html)
...
如需詳細資訊，請參閱[新增使用者與使用者群組](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/user-management/add-users-user-groups)。
...
如需詳細資訊，請參閱[清除使用者](https://experienceleague.adobe.com/en/docs/learning-manager/using/admin/purge-users)。
...
有關Adobe Learning Manager安全性實務的其他資訊，請參閱[Adobe Learning Manager安全性概覽(PDF)](https://experienceleague.adobe.com/docs/learning-manager/assets/alm-security-whitepaper-2024.pdf)
