...
在目前版本的Adobe學習管理員中，對於檢查清單，即使檢閱者已將模組標籤為失敗，仍允許模組進度。 在此版本中，作者可以設定以防止學習者進度未通過檢查清單。

如需詳細資訊，請參閱 [檢查清單增強功能](authors/feature-summary/courses.md#mandatory-checklist) 在Learning ManagerAdobe中。

## 其他增強功能

### 檢查清單中的變更

建立檢查清單時，您可以選取 **強制檢查清單** 核取方塊。 若學習者未通過檢查清單，這麼做會阻礙模組或課程繼續進行。
