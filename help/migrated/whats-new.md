...
當管理員處分所有課程執行個體（例如，在課程生命週期結束時）時，**[!UICONTROL Course Overview]**&#x200B;頁面上的&#x200B;**[!UICONTROL Enroll]**&#x200B;按鈕會以[!UICONTROL Register Interest]選項取代。 學習者可選取此選項，以表達參加課程的興趣。 管理員現在可以檢視和匯出已註冊課程興趣的學習者清單。
...
回應時，**course:15067_30122_41715_1_3400468**&#x200B;是正在要求資訊的學習物件資源等級識別碼。 可從`GET /enrollments/{id}` API取得`learningObjectResourceGrad`e ID。
