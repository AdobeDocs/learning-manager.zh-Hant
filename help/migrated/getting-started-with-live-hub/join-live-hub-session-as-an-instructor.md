...
1. 從即將到來的場次&#x200B;**中選擇排定的 Live Hub 場次**。
   ...
   ![即將到來的課程講師](assets/upcoming-sessions-instructor.png)
   *選擇即將到來的課程以開啟教室加入的網址。*

1. 從列出的課程中選擇該課程。 <br> **會話總覽**&#x200B;頁面會打開。

   ![會話總覽頁面](assets/session-overview-page.png)
   *會話總覽頁面顯示進入 Live Hub 會話的選項。*

1. 從 Live hub 選擇 **「進入教室** 」。 <br> Live Hub 加入介面開啟。

   ![講師加入前畫面](assets/instructor-pre-join-screen.png)
   *Live Hub 的加入前畫面。*
