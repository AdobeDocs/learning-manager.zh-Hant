...
經理可將學習者註冊到其下的課程、學習路徑及認證。 如需註冊所需的詳細資訊和步驟，請參閱 [註冊學習者。](../../administrators/feature-summary/courses.md#main-pars_header_1058138132)
...
您可以選取「 」，根據能力進行搜尋 **能力** 並加以選取。 身為經理，您可以用四種方式排序課程，以便更妥善地找出您需要的課程。 按一下「排序依據」 ，然後選擇按字母遞增順序、按字母遞減順序、課程更新日期、課程建立日期或課程的成效：
