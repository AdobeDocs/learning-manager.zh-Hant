...
在&#x200B;**品牌** > **學習者首頁**&#x200B;頁面上，管理員可以自訂學習者的首頁體驗，這樣當學習者登入學習者應用程式時，他/她就會看到完全改版的外觀和風格。

管理員可以從管理員應用程式設定UI （外觀） （**品牌** > **學習者首頁**&#x200B;標籤）。
...
若要檢視沈浸式驅動頁面的版面，請啟用選項&#x200B;**沈浸式**。 您可以在&#x200B;**品牌>一般**&#x200B;中切換此選項。
...
* **訓練型別：**&#x200B;選擇&#x200B;**產業**&#x200B;或&#x200B;**自訂校準**。 自訂培訓是內部建立的。 符合業界標準的培訓包括來自協力廠商的現成內容。

![](assets/select-homepage-experience.png)

*選取「產業」或「自訂對齊」以設定首頁體驗*

傳統和沈浸式體驗都可使用&#x200B;**讓學習者探索興趣區域**&#x200B;選項。
...
對於現有帳戶，**沈浸式**&#x200B;選項為&#x200B;**OFF**。 此功能會在社交和遊戲化開啟的情況下針對新帳戶啟用。
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <ol>
     ...
     <li>按一下頁面右上角的<b>新增</b>。</li>
     <li>從<b>型別</b>下拉式清單中選擇<b>作為刊頭</b>。</li>
     <li>撰寫將以刊頭為主題的訊息。</li>
     <li>上傳影像或影片。</li>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>
      <p>首先，管理員<a href="announcements.md#recommendation">建立<b>As Recommendation</b>型別的宣告</a>，然後選取必要的訓練並使用群組。 屬於使用者群組的學習者將可看見建議的培訓課程。</p></li>
     <li>
 ...
 <tbody>
  ...
  <tr>
   <td>
    <p>學習者首頁</p></td>
   <td>
    <p>選擇<b>傳統</b>或<b>沈浸式</b>。 如果您選擇「沈浸式」，則會出現其他選項。</p></td>
  </tr>
  <tr>
   <td>
    <p>訓練型別<br></p></td>
