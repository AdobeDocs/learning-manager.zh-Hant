...
Adobe Learning Manager擁有彈性、客戶友善的定價模型，是符合您組織需求的最佳定價模型之一。 如需詳細資訊，請參閱 [Learning Manager](https://www.adobe.com/products/learningmanager.html) 頁面。

只有貴組織的管理員可以管理帳單。

如果您想聯絡Adobe瞭解更多有關Learning Manager訂閱和計費的資訊，請寫信與我們聯絡： [learningmanagersales@adobe.com](mailto:learningmanagersales@adobe.com).

## 使用信用卡下訂單 {#placeordersusingcreditcards}

透過任何信用卡付款單，最多可購買3500名學習者的訂閱。 帳戶中的第一筆訂單必須至少供10個學習者使用。

1. 在管理員應用程式上，按一下 **[!UICONTROL Billing]** 位於左側導覽窗格。

   ![](assets/billing.png)

   *啟動AdobeLearning Manager帳單*

1. 在 **[!UICONTROL Billing Information]** 頁面，新增使用者人數 **[!UICONTROL Add Users]** 欄位。 使用信用卡進行預付訂閱時，您可以檢視可以為訂閱新增的使用者人數。 您可以新增的使用者數目不得超過Remaining一節中提到的數目。1.
...
1. 下訂單後，若要檢視最近訂購的套件，請按一下 **[!UICONTROL Order History]** 標籤上的 **[!UICONTROL Billing]** 頁面。
...
**已取消已起始：** 當Learning Manager管理員停用帳戶時，訂單會進入此狀態。 在收到訂單的取消確認之後，訂單會進入取消狀態。
...
1. 傳送電子郵件至 [learningmanagersales@adobe.com](mailto:learningmanagersales@adobe.com) 並提及所需學習者數量。
...
* **試用版**  — 您可以建立AdobeLearning Manager帳戶，並在30天內免費使用。 在試用期間註冊的學習者人數沒有限制。
* **作用中**  — 在此狀態下，該帳戶具有根據訂閱訂單每月定期付款的有效學習者訂閱。
...
1. 在顯示的頁面上，您可以檢視下列專案：
   ...
   * **整體使用狀況：** 您可以檢查有效使用者總數、一個月內使用Learning Manager的使用者總數，以及尚未註冊任何課程的使用者人數。
...
在 **產生報表請求** 對話方塊，輸入所需的月份和年份，然後按一下 **[!UICONTROL Generate]**.
...
若要在帳戶中新增訂閱，請為您想要購買訂閱的使用者數量新增使用者數量。 然後在右上角，按一下 **[!UICONTROL Place Order]**. 檢閱估算並按一下 **[!UICONTROL Proceed]**. 輸入您的帳戶詳細資料，以及您的信用卡詳細資料。 然後若要購買訂閱，請按一下 **[!UICONTROL Complete Order]**.
...
在 **[!UICONTROL Order History]** 索引標籤，若為使用中帳戶，請按一下 **[!UICONTROL Edit]**. 然後在「訂閱詳細資料」頁面上，按一下 **[!UICONTROL Edit Subscription]**. 輸入您的新信用卡詳細資料，然後按一下 **[!UICONTROL Update Payment Method]**.
...
1. 登入身份 **管理員** 並按一下 **[!UICONTROL Billing]**.
1. 在訂單清單中，按一下 **[!UICONTROL Edit]**.
1. 在訂閱詳細資訊頁面中，按一下 **[!UICONTROL Edit Subscription]**.

選擇您要編輯的專案：

1. **[!UICONTROL Payment method]：** 使用此選項來更新付款明細，例如，信用卡。
...
連絡人 [Fastspring](https://fastspring.com/) 若要取得付款的商業發票，請使用下列其中一種方式：

* 使用連結與FastSpring建立服務要求 `https://questionacharge.com`.
* 傳送電子郵件至FastSpring，日期： `orders@fastspring.com` 索取發票。
+++
