...
在頁面的右上角，按一下 **[!UICONTROL Add]**，並選擇 **[!UICONTROL Self-Registration]**.
...
1. 在 **[!UICONTROL Add External Registration Profile]** 對話方塊，新增下列詳細資料：
...
您隨時都可以撤銷外部夥伴的暫停狀態，並繼續正常服務。 按一下 **[!UICONTROL Actions]** ，然後選擇 **[!UICONTROL Resume]**.
...
按一下 **作用中的欄位** 「使用者」頁面中提供。 學習者只能從自訂值中指定的值中選擇。
...
您可以在此空間檢視管理員使用大量匯入功能新增之使用者的CSV匯入記錄。 您也可以按一下 **新增** ，可使用CSV上傳功能新增使用者。
...
在 **[!UICONTROL Edit User]** 對話方塊中，更新相應的欄位。 若要儲存變更，請按一下 **[!UICONTROL Save]**.
...
1. 按一下 **[!UICONTROL Users]** > **[!UICONTROL Active Fields]**.
1. 在區段中 **[!UICONTROL Configure fields]**，按一下 **[!UICONTROL Modify Values]**.
