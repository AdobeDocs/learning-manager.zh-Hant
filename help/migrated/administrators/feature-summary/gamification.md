...
Learning Manager可讓您將結構遊戲層套用至內容，以吸引學習者並激勵他們達成學習目標。 它可讓學習者針對各種學習活動取得分數，並達到銅、銀、金和白金級水準。
...
1. 以管理員身分登入，然後在左窗格上按一下 **[!UICONTROL Gamification]**.
1. 建立新的Learning Manager帳戶時，遊戲功能會依預設停用。 若要啟用此功能，請按一下 **[!UICONTROL Enable]** 在頁面的右上角。

## 管理員動作 {#administratoractions}

管理員可以建立機密使用者清單、重設遊戲點數，以及停用/啟用學習者的遊戲化功能。 按一下頁面右上角的「動作」下拉式清單，檢視動作，如下方快照所示。
...
1. 按一下 **[!UICONTROL Gamification]** 在您以管理員身分登入之後。\
...
1. 在管理員登入中，按一下 **[!UICONTROL Gamification]** 在左窗格。
1. 開啟 **[!UICONTROL Gamifications]** > **[!UICONTROL Settings]** > **[!UICONTROL Scope Settings]**. 此 [!UICONTROL Gamification Scope Settings] 對話方塊隨即顯示。
