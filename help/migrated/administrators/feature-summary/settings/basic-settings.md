...
啟用帳號層級權限，允許作者顯示或隱藏每門課程的成績冊。 啟用後，作者會在課程編輯器中看到「向學習者顯示成績簿」選項。 學習者會在課程播放器中看到作者啟用的任何課程的成績簿分頁。 在帳號層級關閉此設定會覆蓋所有課程層級的設定。 學習者在重新啟用設定前，將無法在任何課程中看到成績簿。 欲了解更多資訊，請參閱 [行政成績](/help/migrated/administrators/feature-summary/alm-admin-gradebook.md)簿。
