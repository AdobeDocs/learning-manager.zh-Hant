...
>[!NOTE]
>
>只有管理員能在任何層級建立、編輯或刪除資料夾。 擁有任何根目錄層級資料夾存取權的自訂管理員，可以在該根目錄下建立、編輯或刪除資料夾。
...
內容庫會顯示每個內容檔案的完整資料夾路徑。 例如，**培訓計畫**/**入職**&#x200B;**/SCORM資產**。此路徑顯示內容的完整位置。
...
對於區域作者而言，作為自訂角色，在自訂角色建立時只能選擇第一層資料夾。 二級資料夾選擇不是選項。 他們只能找到、更新並重複使用與其管轄區相關的資產，而不會看到或意外修改其他地區的內容。
...
* 你可以在任何層級刪除空資料夾。
* 只有空資料夾才能被刪除。 包含內容的資料夾無法刪除，無論內容是否連結到其他資料夾。
* 刪除父資料夾會刪除所有子資料夾，前提是該資料夾及其所有子資料夾都是空的。 選擇父資料夾會自動選取其所有子資料夾。
...
**Adobe Learning Manager 中的假期**&#x200B;設定可以讓你定義全組織的假期。假日在講師行事曆上顯示為非工作日，影響講師排班時的可用時間樞紐會議。
