...
4. 輸入報告名稱。需要一個名字。可選擇性地輸入描述。   ![](assets/image011.png)
5. 在欄位面板中，選擇以下資料集並展開：a. 使用者b. 學習物件c. 使用者合規狀態
...
1. 請選擇 **右上角的動作** 。   ![](assets/image013.png)
2. 選擇下載。 當報告準備好時，你可以從通知圖示下載。

下載的報告以.csv檔名形式包含以下欄位：
...
1. 打開報告，並在右上角選擇 **編輯** 。
2. 選擇 **新增篩選器** ，並在你想套用篩選器的欄位搜尋。   ![](assets/image014.png)
3. 選擇 **新增**。
4. 將濾波器與 AND/OR 邏輯結合;選擇篩選器列間的操作員切換。   ![](assets/image015.png)
5. 選擇 **儲存報告** 並下載報告。
...
1. 打開報告，並在右上角選擇 **編輯** 。
2. 選擇&#x200B;**群組並選擇**&#x200B;使用者管理員名稱&#x200B;**:Select**&#x200B;欄位。   ![](assets/image016.png)
3. 彙總以下欄位：a. 使用者\名稱b. 學習物件\學習物件名稱
4. 選擇 **「計數** 」作為欄位的彙總函數。   ![](assets/image017.png)
5. 學習物件\學習物件名稱重複此步驟。   ![](assets/image018.png)
6. 選擇 **儲存報告** 並下載報告。
