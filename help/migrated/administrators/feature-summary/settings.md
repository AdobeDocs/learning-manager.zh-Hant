...
若要更新貴組織的帳戶設定，請按一下左窗格中的&#x200B;**[!UICONTROL Settings]**。

**基本資訊（公司資訊）**

按一下頁面上的&#x200B;**[!UICONTROL Change]**，並編輯國家/地區、時區、地區設定及財政年度設定。

**設定連絡人管理員**

如果您想要新增或變更貴組織的支援管理員電子郵件地址，請按一下左窗格上的「**[!UICONTROL General]**」進行設定。 按一下&#x200B;**[!UICONTROL Change]**&#x200B;旁的&#x200B;**[!UICONTROL Support Email ID]**&#x200B;並新增電子郵件ID。 當學習者按一下頁面頁尾的&#x200B;**[!UICONTROL Contact Admin]**&#x200B;時，系統會將電子郵件傳送給這些管理員。

新增其他以分號作為分隔符號的電子郵件ID。

**登入方法** — 管理員可以選擇您的內部或外部使用者存取帳戶的模式。
...
您可以使用Adobe ID或單一登入存取Learning Manager應用程式。 單一登入是一種機制，可讓使用者驗證一次，並多次存取多個應用程式。 組織不強制進行此設定。 如果您的組織有以SAML 2.0為基礎的SSO提供者，您可以使用它來設定Learning Manager應用程式。 您的組織層級和Learning Manager應用程式需要此設定。 如果您選擇使用SSO，請聯絡Adobe支援以接收設定指示
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li>對於<b>使用中帳戶</b>，摘要電子郵件預設為停用，管理員可以手動啟用它。</li>
     <li>對於<b>試用帳戶</b>，摘要電子郵件的選項將保持停用狀態，而且管理員無法啟用該選項。</li>
    </ul>
    <p>如果功能已停用，則：</p>
    <ul>
     <li>將停用<b>摘要電子郵件</b>選項。</li>
     <li>學習者看不到摘要電子郵件訂閱的使用者設定。</li>
    </ul>
    <p> 如果已啟用該功能，則：</p>
    <ul>
     <li>管理員可以啟用和修改摘要電子郵件選項。</li>
     <li>在學習者應用程式上的<b>設定檔設定</b>中，學習者（不在DND清單中）可以選擇訂閱/取消訂閱摘要電子郵件。</li>
    </ul></td>
  </tr>
  <tr>
   <td>啟用訓練卡圖示<br></td>
  ...
  <tr>
   ...
   <td>
    ...
    <ol>
     ...
     <li>若要跨所有地區設定重疊顯示變更，請按一下[復寫]。<b></b> 這可確保所有語言都可取得名稱和url。</li>
     <li>若要儲存變更，請按一下<b>儲存</b>。 您可以看到確認變更的快顯訊息。 按一下「確定」後，頁尾會填入新加入的連結。</li>
    </ol>
    <p>此外，您可以：</p>
    <ul>
     <li>按一下<b>重設</b>圖示以重設<b>說明</b>和<b>連絡管理員</b>欄位中的預設值。</li>
     <li>自訂所有語言頁尾的連結。 按一下<b>語言</b>下拉式清單，選取語言，然後在指定的欄位中新增<b>名稱</b>和<b>URL</b>。 儲存變更後，更新的連結會出現在頁尾中。<br></li>
    </ul></td>
  </tr>
  <tr>
   <td>報表時區<br></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="1709">
 <tbody>
  ...
  <tr>
   <td height="19">在搜尋結果中顯示所有已註冊的課程</td>
   <td>如果啟用「 」，學習者即使用已註冊學習路徑或認證，仍可在搜尋結果中檢視課程。</td>
  </tr>
 </tbody>
</table>
 ...
 <tbody>
  <tr>
   <td>
    <p>學習路徑</p></td>
   <td>
    <p>如果選取了<b>啟用學習路徑的延伸功能</b>選項，管理員可以在學習路徑中包含學習路徑，並將這些學習路徑與課程結合。 選項是不可逆的。<br></p></td>
  </tr>
  <tr>
   <td>
    <p>講師管理<br></p></td>
...
>[!NOTE]
>
>一旦啟用技能匯入設定，帳戶配置就無法切換到傳統檢視，也就是說，在啟用&#x200B;**技能匯入**&#x200B;選項後，切換到傳統帳戶功能就會停用。
...
1. 按一下您的像片/帳戶旁右上角的下拉箭頭，然後選擇&#x200B;**[!UICONTROL Profile Settings]**。
1. 在快顯對話方塊中，您可以在設定檔像片區域中將滑鼠游標停留並按一下「**[!UICONTROL Edit]**」來新增/變更像片。
1. 按一下旁邊的&#x200B;**[!UICONTROL About]**&#x200B;以新增/修改&#x200B;**[!UICONTROL Edit]**&#x200B;內容。
...
若要新增內容資料夾，請在系統管理員應用程式中按一下&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Content Folder]**。
...
若要新增資料夾，請按一下視窗右上角的&#x200B;**[!UICONTROL Add]**。
...
* **允許作者修改和刪除位置**：
啟用後，作者將能夠修改和刪除所有教室位置。 作者的修改會反映在整個平台中，包括報表。

## 常見問題 {#frequentlyaskedquestions}

+++如何為內容庫建立不同的資料夾？

按一下&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Content Folder]**。 若要新增資料夾，請按一下右上角的&#x200B;**[!UICONTROL Add]**，然後在對話方塊中輸入資料夾的名稱和說明。

管理員可設定內容資料夾。 設定後，作者才能看見內容資料夾，且可以將內容放置在一或多個資料夾中。

如需詳細資訊，請參閱[內容資料夾](settings.md#content-folder)的相關章節。
+++
