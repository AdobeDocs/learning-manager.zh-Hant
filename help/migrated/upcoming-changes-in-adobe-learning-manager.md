...
| 情境 | 影響 | 需要動作 |
|----------|--------|----------------|
| 您可以透過欄名稱來識別「管理員LT」中的欄位（例如「提交註解」） | 欄標題將變更為稽核者的備註。 | 是。 更新參考提交註解的任何對應或邏輯以使用稽核者註解。 |
...
| 您可以使用聯結器匯出的LT並按欄名稱對應 | 將會出現新的欄檢閱者註解。 | 選填。 除非您想要使用新的稽核者/檢查清單註解資料，否則不需要變更。 |
