...
>[!IMPORTANT]
>
>請注意，概述的功能為暫定功能，可能會有變動。 如需詳細資訊和確認，請洽詢您指定的客戶成功案例經理。 如果您遇到任何問題，請透過[learningmanagersupport@adobe.com](mailto:learningmanagersupport@adobe.com)聯絡我們的客戶支援團隊
...
Go1整合已增強，可支援播放清單管理、學習路徑建立和循環認證工作流程，同時轉換至預覽並購買內容模型。

**新增功能**

* 使用AI聊天協助或手動選擇，直接在Go1中建立和管理播放清單。
* 輕鬆將Go1播放清單轉換為Adobe Learning Manager學習路徑。
...
管理員可以根據位置、角色、產品和其他條件，針對不同的學習者群組量身打造的Go1課程，以建立播放清單。 播放清單可以手動建立，或使用AI產生。

若要建立播放清單：

1. 以管理員身分登入Adobe Learning Manager。
2. 在左側導覽窗格中選取&#x200B;**[!UICONTROL Content Marketplace]**。
...
b. **[!UICONTROL by myself]**：手動新增課程以建立播放清單。
   ...
   _選取[建立播放清單]，在Adobe Learning Manager中建立新的播放清單，以便為學習者整理及傳遞目標式課程_

**使用AI建立播放清單**

管理員可以在AI提示中輸入播放清單說明。 AI將會組織相關課程，並根據需求建立播放清單。
...
4. 從清單中選擇技能，然後選取課程持續時間並輸入您的播放清單。
5. 選取&#x200B;**[!UICONTROL Generate playlist]**。

   ![](assets/select-generate-playlist.png)
   _選取相關技能與課程持續時間，在Adobe Learning Manager中自訂您的播放清單_


播放清單是以10個課程建立的，管理員可使用此清單建立學習路徑。
...
6. 在&#x200B;**[!UICONTROL Library]**&#x200B;中，搜尋並選取Select **[!UICONTROL Go1 Courses screen]**&#x200B;上的播放清單。

   >[!NOTE]
   >
   >請務必設定「由我建立」篩選器，以輕鬆找到您的播放清單。

   ![](assets/select-save-to-add-playlist.png)
   _從Adobe Learning Manager的Go1課程庫中選取銷售工程師播放清單_

7. 選取&#x200B;**[!UICONTROL Add to Library]**，然後選取&#x200B;**[!UICONTROL Save]**。

   ![](assets/add-playlist-to-lp.png)
   _從Adobe Learning Manager的Go1資料庫中選取並匯入銷售工程師技能增強播放清單_

8. 選取&#x200B;**[!UICONTROL Add]**，然後選取&#x200B;**[!UICONTROL Publish]**。
